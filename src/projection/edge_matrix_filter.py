...
def ud_filter(P, M_in, enforce_function_leaves=True, promote_first_content_to_root=True, enforce_single_root=True,
              attach_last_punct_to_root=True, punish_punct_nonproj=True):
    M = copy.copy(M_in)

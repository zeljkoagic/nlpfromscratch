...
parser.add_argument('--with_pp', required=True, choices=[False, True], help="project POS with alignment probabilities instead unit votes", type=bool)
parser.add_argument('--trees', required=True, choices=[False, True], help="project dependency trees instead of weight matrices", type=bool)
parser.add_argument('--binary', required=True, choices=[False, True], help="use binary alignments instead of alignment probabilities", type=bool)
